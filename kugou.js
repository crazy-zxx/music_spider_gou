...
function() {
    ...
    function b(b, c, d) {
        ...
        var e,
            f = !1,
            g = "json";
        "function" == typeof d ? e = d : (e = d.callback, f = d.useH5 || !1, g = d.postType || "json");
        var h = {};
        for (var i in b)
            !h[i] && (h[i] = b[i]);
        var j = function() {
                ...
                !function(a) {
                    function b(a) {
                        if (a < l.length)
                            ...
                            for (var d in h)
                                n.push(d);
                            if (n.sort(), n.forEach(function(a) {
                                o.push(a + "=" + h[a])
                            }), c)
                                if ("[object Object]" == Object.prototype.toString.call(c))
                                    if ("json" == g)
        ...
        if (c && ("[object Object]" != Object.prototype.toString.call(c) ? j = !1 : "urlencoded" == g && (j = !1)), j && !f) {
            var s = !1;
            a(function() {
